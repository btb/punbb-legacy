...
$main_elements['<!-- forum_main_h1 -->'] =  '<h1 class="main-title">'.((isset($forum_page['main_h1'])) ? $forum_page['main_h1'] : end($forum_page['crumbs'])).(isset($forum_page['main_head_pages']) ? ' <small>'.$forum_page['main_head_pages'].'</small>' : '').'</h1>'."\n";
