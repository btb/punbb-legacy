...
// Announcement
$gen_elements['<!-- forum_announcement -->'] = ($forum_config['o_announcement'] == '1' && $forum_user['g_read_board'] == '1') ? '<div id="brd-announcement">'."\n\t".($forum_config['o_announcement_heading'] != '' ? "\n\t\t".'<div class="msg-head">'."\n\t\t\t".'<h1 class="hn">'.$forum_config['o_announcement_heading'].'</h1>'."\n\t\t".'</div>'."\n\t" : '').'<div class="userbox gen-content">'."\n\t\t".$forum_config['o_announcement_message']."\n\t".'</div>'."\n".'</div>'."\n" : '';
...
$main_elements['<!-- forum_main_h1 -->'] =  '<h1 class="hn">'.((isset($forum_page['main_h1'])) ? $forum_page['main_h1'] : end($forum_page['crumbs'])).(isset($forum_page['main_head_pages']) ? ' <small>'.$forum_page['main_head_pages'].'</small>' : '').'</h1>';
